...
enum PerfectCampaignsEnum {
    ...
    /* 48 */ CAMPAIGN_KARATE_MAN_EXTRA = TOTAL_PERFECT_CAMPAIGNS,
...
enum RhythmGameLevelsEnum {
    ...
    /* 55 */ LEVEL_KARATE_MAN_EXTRA = TOTAL_LEVELS,
...
#define TOTAL_EXTRA_LEVELS (END_EXTRA_LEVELS - TOTAL_LEVELS)
#define TOTAL_EXTRA_PERFECT_CAMPAIGNS (END_EXTRA_PERFECT_CAMPAIGNS - TOTAL_PERFECT_CAMPAIGNS)

#define ALL_LEVELS (TOTAL_LEVELS + TOTAL_EXTRA_LEVELS)
#define ALL_RHYTHM_GAMES (TOTAL_RHYTHM_GAMES + TOTAL_EXTRA_PERFECT_CAMPAIGNS)
#define ALL_PERFECT_CAMPAIGNS (TOTAL_PERFECT_CAMPAIGNS + TOTAL_EXTRA_PERFECT_CAMPAIGNS)
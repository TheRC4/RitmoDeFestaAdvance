...
const char D_080676b4[] = "A primeira parte foi um pouco difícil...";

const char D_080676d4[] = "A primeira metade foi muito boa!";

const char D_080676ec[] = "A segunda metade foi bem seca.";

const char D_08067710[] = "A segunda metade foi incrível!";

const char D_0806772c[] = "";

const char D_08067730[] = "A emoção aumentou bastante no final!";
